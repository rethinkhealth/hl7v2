/**
 * Benchmarks for hl7v2-lint-profile-field-repetition.
 *
 * Run: pnpm bench
 */
...
const processor = unified().use(hl7v2LintFieldRepetition);

describe("field-repetition performance", () => {
  const small = m(
    msh("2.5"),
  ...
  bench("xl (102 segments, 3 unique types)", async () => {
