// Generated table profile for 0003 (v2.3.1)
...
export const codes = [
  ...
  { description: "QRY/DSR - query for display results", name: "R05" },
  ...
  {
    description: "R0R - Pharmacy prescription order query response",
    name: "R0R",
  },
  {
