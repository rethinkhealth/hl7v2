// Generated table profile for 0211 (v2.7.1)

export const id = "0211";
export const description = "Alternate Character Sets";
...
export const codes = [
  ...
  { description: "The printable 7-bit ASCII character set.", name: "ascii" },
  { description: "Code for Taiwanese Character Set (BIG-5)", name: "BIG-5" },
  {
