// Generated datatype profile for XCN (v2.7.1)
...
export const components = [
  { sequence: 1, name: "Person Identifier", datatypeId: "ST", required: false },
  ...
  { sequence: 8, name: "Source Table", datatypeId: "CWE", required: false },
  {
    sequence: 9,
  ...
  { sequence: 16, name: "Name Context", datatypeId: "CWE", required: false },
  {
    sequence: 18,
  ...
  { sequence: 19, name: "Effective Date", datatypeId: "DTM", required: false },
  { sequence: 20, name: "Expiration Date", datatypeId: "DTM", required: false },
  {
    sequence: 21,
  ...
  { sequence: 24, name: "Security Check", datatypeId: "ST", required: false },
  {
    sequence: 25,
