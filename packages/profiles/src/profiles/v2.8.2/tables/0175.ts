...
export const codes = [
  ...
  { name: "MACP", description: "Medicare Approved Coverage Process" },
  { name: "MLCP", description: "Medicare Limited Coverage Process" },
  ...
  { name: "OMM", description: "Mixed type observation master file" },
