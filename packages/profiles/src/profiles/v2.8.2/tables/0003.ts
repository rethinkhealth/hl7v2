// Generated table profile for 0003 (v2.8.2)
...
export const codes = [
  ...
  { description: "ADT/ACK - Merge person - patient ID", name: "A39" },
  {
  ...
  { description: "ADT/ACK - Change patient ID", name: "A46" },
  ...
  { description: "PMU/ACK - Grant Certificate/Permission", name: "B07" },
  { description: "PMU/ACK - Revoke Certificate/Permission", name: "B08" },
  ...
  { description: "Submit HealthCare Services Invoice", name: "E01" },
  { description: "Cancel HealthCare Services Invoice", name: "E02" },
  { description: "HealthCare Services Invoice Status", name: "E03" },
  { description: "Re-Assess HealthCare Services Invoice Request", name: "E04" },
  { description: "Edit/Adjudication Results", name: "E10" },
  { description: "Request Additional Information", name: "E12" },
  { description: "Additional Information Response", name: "E13" },
  { description: "Payment/Remittance Advice", name: "E15" },
  { description: "Submit Authorization Request", name: "E20" },
  { description: "Cancel Authorization Request", name: "E21" },
  { description: "Authorization Request Status", name: "E22" },
  { description: "Authorization Response", name: "E24" },
  {
  ...
  { description: "Collaborative Care Referral", name: "I16" },
  { description: "Modify Collaborative Care Referral", name: "I17" },
  { description: "Cancel Collaborative Care Referral", name: "I18" },
  {
    description: "Collaborative Care Query/Collaborative Care Query Update",
    name: "I19",
  },
  { description: "Asynchronous Collaborative Care Update", name: "I20" },
  { description: "Collaborative Care Message", name: "I21" },
  {
  ...
  { description: "RTB - Tabular response in response to QBP^Q13", name: "K13" },
  { description: "RDY - Display response in response to QBP^Q15", name: "K15" },
  ...
  { description: "RSP -Dispense History Response", name: "K31" },
  {
    description: "Find Candidates including Visit Information Response",
    name: "K32",
  },
  { description: "Get Donor Record Candidates Response Message", name: "K33" },
  { description: "Segment Pattern Response Message", name: "K34" },
  { description: "MFN/MFK - Master file not otherwise specified", name: "M01" },
  ...
  { description: "MFN/MFK - Master file notification - general", name: "M13" },
  {
  ...
  { description: "DRG Master File Message", name: "M17" },
  {
    description:
  ...
  { description: "ORD - Diet order acknowledgment", name: "O04" },
  { description: "OMS - Stock requisition order", name: "O05" },
  { description: "ORS - Stock requisition acknowledgment", name: "O06" },
  { description: "OMN - Non-stock requisition order", name: "O07" },
  { description: "ORN - Non-stock requisition acknowledgment", name: "O08" },
  { description: "OMP - Pharmacy/treatment order", name: "O09" },
  { description: "ORP - Pharmacy/treatment order acknowledgment", name: "O10" },
  ...
  { description: "RRG - Pharmacy/treatment give acknowledgment", name: "O16" },
  ...
  { description: "OMI - Imaging order", name: "O23" },
  {
  ...
  { description: "OMB - Blood product order", name: "O27" },
  { description: "ORB - Blood product order acknowledgment", name: "O28" },
  { description: "BPS - Blood product dispense status", name: "O29" },
  {
    description: "BRP - Blood product dispense status acknowledgment",
    name: "O30",
  },
  { description: "BTS - Blood product transfusion/disposition", name: "O31" },
  {
  ...
  { description: "Specimen shipment centric laboratory order", name: "O39" },
  {
    description:
      "Specimen Shipment Centric Laboratory Order Acknowledgment Message",
    name: "O40",
  },
  { description: "DBC - Create Donor Record Message", name: "O41" },
  { description: "DBU - Update Donor Record Message", name: "O42" },
  {
    description:
      "General Order Message with Document Payload Acknowledgement Message",
    name: "O43",
  },
  { description: "Donor Registration - Minimal Message", name: "O44" },
  { description: "Donor Eligibility Observations Message", name: "O45" },
  { description: "Donor Eligiblity Message", name: "O46" },
  { description: "Donor Request to Collect Message", name: "O47" },
  { description: "Donation Procedure Message", name: "O48" },
  ...
  { description: "BAR/ACK - Update Diagnosis/Procedure", name: "P12" },
  ...
  { description: "ROR - Pharmacy/treatment order response", name: "Q26" },
  {
    description: "RAR - Pharmacy/treatment administration information",
    name: "Q27",
  },
  { description: "RDR - Pharmacy/treatment dispense information", name: "Q28" },
  {
    description: "RER - Pharmacy/treatment encoded order information",
    name: "Q29",
  },
  { description: "RGR - Pharmacy/treatment dose information", name: "Q30" },
  { description: "QBP Query Dispense history", name: "Q31" },
  { description: "Find Candidates including Visit Information", name: "Q32" },
  { description: "QBP - Get Donor Record Candidates", name: "Q33" },
  { description: "QBP - Get Donor Record", name: "Q34" },
  {
  ...
  { description: "ORA - Observation Report Acknowledgement", name: "R33" },
  { description: "ORU - Unsolicited Report Alarm", name: "R40" },
  { description: "Observation Report Alert Acknowledgement", name: "R41" },
  {
  ...
  { description: "SLR/SLS - Request new sterilization lot", name: "S28" },
  { description: "SLR/SLS - Request Sterilization lot deletion", name: "S29" },
  { description: "STI/STS - Request item", name: "S30" },
  { description: "SDR/SDS - Request anti-microbial device data", name: "S31" },
  {
  ...
  { description: "SLN/ACK - Notification of sterilization lot", name: "S34" },
  {
