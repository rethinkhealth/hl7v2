...
export const codes = [
  { description: "Order refille request approval", name: "AF" },
  ...
  { description: "Order refill request denied", name: "DF" },
  { description: "Discontinued as requested", name: "DR" },
  { description: "Order refilled, unsolicited", name: "FU" },
  ...
  { description: "Order released", name: "OE" },
  { description: "Order refilled as requested", name: "OF" },
  ...
  { description: "Refill order request", name: "RF" },
  ...
  { description: "Unable to accept order", name: "UA" },
