...
export const codes = [
  ...
  { description: "", name: "TD<integer>" },
  { description: "", name: "TH<integer>" },
  { description: "", name: "TL<integer>" },
  { description: "", name: "TM<integer>" },
  { description: "", name: "TS<integer>" },
  { description: "", name: "TW<integer>" },
] as const;
