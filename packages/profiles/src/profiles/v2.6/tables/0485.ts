// Generated table profile for 0485 (v2.6)
...
export const codes = [
  ...
  { name: "TD<integer>", description: "" },
  { name: "TH<integer>", description: "" },
  { name: "TL<integer>", description: "" },
  { name: "TM<integer>", description: "" },
  { name: "TS<integer>", description: "" },
  { name: "TW<integer>", description: "" },
] as const;
