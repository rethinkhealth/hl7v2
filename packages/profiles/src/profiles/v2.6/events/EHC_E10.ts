// Generated profile automaton for EHC_E10 (v2.6)
...
export const effects = {
  ...
  "13:PSL": {
    groupsClosed: [],
    groupsOpened: [
      "EHC_E10/INVOICE_PROCESSING_RESULTS_INFO/PRODUCT_SERVICE_SECTION/PRODUCT_SERVICE_GROUP/PRODUCT/SERVICE LINE_INFO",
    ],
  },
  "14:IPR": {
    groupsClosed: [
