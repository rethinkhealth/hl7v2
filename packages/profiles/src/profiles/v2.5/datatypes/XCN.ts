// Generated datatype profile for XCN (v2.5)
...
export const components = [
  ...
  { datatypeId: "TS", name: "Effective Date", required: false, sequence: 19 },
  { datatypeId: "TS", name: "Expiration Date", required: false, sequence: 20 },
  {
    datatypeId: "ST",
