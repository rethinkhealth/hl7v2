// Generated datatype profile for PPN (v2.5)
...
export const components = [
  ...
  { sequence: 20, name: "Effective Date", datatypeId: "TS", required: false },
  { sequence: 21, name: "Expiration Date", datatypeId: "TS", required: false },
  {
    sequence: 22,
