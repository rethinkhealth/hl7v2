// Generated datatype profile for XTN (v2.8.1)
...
export const components = [
  ...
  { sequence: 5, name: "Country Code", datatypeId: "SNM", required: false },
  { sequence: 6, name: "Area/City Code", datatypeId: "SNM", required: false },
  { sequence: 7, name: "Local Number", datatypeId: "SNM", required: false },
  { sequence: 8, name: "Extension", datatypeId: "SNM", required: false },
