// Generated profile automaton for REF_I12 (v2.6)
...
export const effects = {
  "11:NTE": {
    groupsOpened: [],
    groupsClosed: ["REF_I12/PATIENT VISIT"],
  },
  "12:OBR": {
  ...
  "12:PV1": {
    groupsOpened: ["REF_I12/PATIENT VISIT"],
    groupsClosed: ["REF_I12/OBSERVATION", "REF_I12/OBSERVATION/RESULTS_NOTES"],
  },
  "13:AUT": {
    groupsOpened: ["REF_I12/PROCEDURE/AUTHORIZATION_CONTACT"],
    groupsClosed: [],
  },
  "13:NTE": {
    groupsOpened: [],
    groupsClosed: [
      "REF_I12/OBSERVATION",
      "REF_I12/PATIENT VISIT",
      "REF_I12/PROCEDURE",
      "REF_I12/PROCEDURE/AUTHORIZATION_CONTACT",
    ],
  },
  "13:OBR": {
    groupsOpened: ["REF_I12/OBSERVATION"],
