...
export const codes = [
  ...
  { name: "AU", description: "Audio data  (new with HL7 v 2.3)" },
  { name: "Audio", description: "Audio data  (HL7 V2.3 and later)" },
  { name: "FT", description: "Formatted text (HL7 V2.2 only)" },
  { name: "IM", description: "Image data  (new  with HL7 v 2.3)" },
  { name: "Image", description: "Image data  (HL7 V2.3 and later)" },
